...
export default function Invoice() {
  ...
  const dueDateLabel = isCancelled
    ? "Dibatalkan"
    : isRefundPending
      ? "Dibatalkan - Refund Diproses"
      : isRefunded
        ? "Dibatalkan - Dana Dikembalikan"
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8 px-4 font-sans text-gray-800">
      ...
      <div className="max-w-4xl mx-auto mb-6 flex justify-between items-center print:hidden">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors bg-white px-4 py-2 rounded-xl border border-gray-200 shadow-sm cursor-pointer"
        >
        ...
        <div className="flex gap-3">
          <button
            ...
            className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-xl shadow-sm transition-colors font-medium cursor-pointer"
          >
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-8 sm:p-12 print:shadow-none print:border-none print:p-0">
        ...
        <div className="flex justify-between items-start mb-12">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-black text-emerald-600 mb-1">
              SayurSehat
            </h1>
          ...
          <div className="text-right">
            <h2 className="text-3xl font-bold text-gray-800 tracking-wider mb-2">
              INVOICE
            </h2>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-12">
          ...
          <div className="bg-gray-100 rounded-2xl p-6 min-w-[250px] border border-gray-200">
            ...
            {(isCancelled || isRefundPending || isRefunded) && (
              <div
                className={`mt-3 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-bold uppercase tracking-wider ${
                  isRefundPending
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 text-center text-xs text-gray-500">
          ...
          <p className="mt-1">
            Invoice ini sah dan diterbitkan secara elektronik.
          </p>
        </div>
      </div>
