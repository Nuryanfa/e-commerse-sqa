...
export default function Products() {
  ...
  return (
    <div className="bg-gray-50/30 dark:bg-slate-900 min-h-screen pb-24 font-sans transition-colors duration-300">
      ...
      {/* Hero Banner Section */}
      <div className="relative overflow-hidden bg-emerald-900 pt-16 pb-24 px-4 sm:px-6 lg:px-8 mb-8 isolate">
         ...
         <div className="relative z-10 max-w-7xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
               <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-800/50 text-emerald-200 text-xs font-black tracking-widest uppercase mb-4 border border-emerald-500/30 backdrop-blur-md">
               ...
               <p className="text-emerald-100/80 max-w-2xl mx-auto text-sm sm:text-base font-medium leading-relaxed">
                 Tingkatkan gaya hidup sehat Anda dengan hasil panen terbaik, langsung dari para petani lokal terpercaya ke dapur Anda. 
               </p>
            </motion.div>
         </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20">
        ...
        {/* Search & Filter Bar */}
        <div className="bg-white dark:bg-slate-800 rounded-3xl p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xl shadow-emerald-900/5 border border-gray-100 dark:border-slate-700/50 mb-8 sm:sticky sm:top-20">
          ...
          <div className="relative w-full sm:max-w-md">
             ...
             <input type="text" value={search} onChange={e => setSearch(e.target.value)} placeholder="Cari kale, wortel, alpukat..." 
                    className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-gray-50 dark:bg-slate-900 border border-transparent focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 text-sm font-bold text-gray-900 dark:text-white outline-none transition-all placeholder-gray-400" />
          </div>
        ...
        {/* Categories Pills */}
        <div className="flex overflow-x-auto gap-3 pb-4 mb-4 custom-scrollbar sticky top-[148px] z-10 bg-gray-50/90 dark:bg-slate-900/90 backdrop-blur-md pt-2 -mx-4 px-4 sm:mx-0 sm:px-0 scroll-smooth">
